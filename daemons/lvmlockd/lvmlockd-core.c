			     ...
			     int *retry_out)
{
	...
	/*
	 * TODO: handle changing a transient vg lock to a
	 * persistent vg lock.  (Use CONVERT flag to allow this?)
	 * This is for 'vgchange --lock-vg mode' where the
	 * a transient vg lock is acquired to read the vg
	 * before the specific lock-vg command is processed.
	 */
