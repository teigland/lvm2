...
int lm_lock_dlm(struct lockspace *ls, struct resource *r, int ld_mode, uint32_t *version);
int lm_convert_dlm(struct lockspace *ls, struct resource *r,
		   int ld_mode, uint32_t version);
int lm_unlock_dlm(struct lockspace *ls, struct resource *r, uint32_t version, uint32_t lmuf_flags);
...
int lm_lock_sanlock(struct lockspace *ls, struct resource *r, int ld_mode,
		    char *lv_args, uint32_t *version, int *retry);
int lm_convert_sanlock(struct lockspace *ls, struct resource *r,
		       int ld_mode, uint32_t version);
int lm_unlock_sanlock(struct lockspace *ls, struct resource *r, uint32_t version, uint32_t lmuf_flags);
