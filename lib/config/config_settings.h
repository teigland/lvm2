...
cfg(global_use_lvmlockd_CFG, "use_lvmlockd", global_CFG_SECTION, 0, CFG_TYPE_BOOL, 0, vsn(1, 0, 0), NULL)
cfg(global_local_host_id_CFG, "local_host_id", global_CFG_SECTION, CFG_ALLOW_EMPTY, CFG_TYPE_STRING, 0, vsn(1, 0, 0), NULL)
cfg(global_lvmlockd_sanlock_host_id_CFG, "lvmlockd_sanlock_host_id", global_CFG_SECTION, CFG_ALLOW_EMPTY, CFG_TYPE_INT, 0, vsn(1, 0, 0), NULL)
...
cfg(metadata_vgcreate_clustery_lock_type_CFG, "vgcreate_clustery_lock_type", metadata_CFG_SECTION, CFG_ALLOW_EMPTY, CFG_TYPE_STRING, NULL, vsn(1, 0, 0), NULL)
cfg(metadata_vgcreate_clustern_lock_type_CFG, "vgcreate_clustern_lock_type", metadata_CFG_SECTION, CFG_ALLOW_EMPTY, CFG_TYPE_STRING, NULL, vsn(1, 0, 0), NULL)
cfg(metadata_vgcreate_default_lock_type_CFG, "vgcreate_default_lock_type", metadata_CFG_SECTION, CFG_ALLOW_EMPTY, CFG_TYPE_STRING, NULL, vsn(1, 0, 0), NULL)
