...
cfg(global_use_lvmlockd_CFG, "use_lvmlockd", global_CFG_SECTION, 0, CFG_TYPE_BOOL, 0, vsn(0, 0, 0), NULL)
cfg(global_lvmlockd_gl_type_CFG, "lvmlockd_gl_type", global_CFG_SECTION, 0, CFG_TYPE_STRING, NULL, vsn(0, 0, 0), NULL)
cfg(global_lvmlockd_gl_args_CFG, "lvmlockd_gl_args", global_CFG_SECTION, 0, CFG_TYPE_STRING, NULL, vsn(0, 0, 0), NULL)
